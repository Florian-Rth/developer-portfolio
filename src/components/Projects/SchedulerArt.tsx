...
/** Connected graph network with flowing data streams — Enhanced scheduling optimization
   - Clean/Tech Vibe (blue, teal, gray)
   ...
   - Tech-oriented data flow visualization */

export const SchedulerArt: React.FC = () => (
  <svg viewBox="0 0 400 200" fill="none" aria-hidden="true" className="w-full h-full">
    <defs>
      ...
      <radialGradient id="sc-bg" cx="50%" cy="50%" r="60%">
        ...
        <stop offset="50%" stopColor="#2E8B57" stopOpacity="0.25" />
        <stop offset="100%" stopColor="#6B7280" stopOpacity="0.15" />
      </radialGradient>
      
      <radialGradient id="sc-bg-deep" cx="50%" cy="50%" r="50%">
        <stop offset="0%" stopColor="#4A90A4" stopOpacity="0.2" />
        <stop offset="100%" stopColor="#6B7280" stopOpacity="0.05" />
      </radialGradient>

      <linearGradient id="sc-edge" x1="0" y1="0" x2="1" y2="0">
        <stop offset="0%" stopColor="#4A90A4" stopOpacity="0.5" />
        <stop offset="50%" stopColor="#2E8B57" stopOpacity="0.4" />
        <stop offset="100%" stopColor="#6B7280" stopOpacity="0.5" />
      </linearGradient>

      <radialGradient id="sc-node-main" cx="50%" cy="40%" r="50%">
        <stop offset="0%" stopColor="#2E8B57" stopOpacity="0.9" />
        <stop offset="70%" stopColor="#4A90A4" stopOpacity="0.7" />
        <stop offset="100%" stopColor="#6B7280" stopOpacity="0.6" />
      </radialGradient>

      <radialGradient id="sc-node-sec" cx="50%" cy="40%" r="50%">
        <stop offset="0%" stopColor="#4A90A4" stopOpacity="0.7" />
        <stop offset="100%" stopColor="#2E8B57" stopOpacity="0.5" />
      </radialGradient>

      <linearGradient id="sc-edge-hover" x1="0" y1="0" x2="1" y2="0">
        <stop offset="0%" stopColor="#2E8B57" stopOpacity="0.6" />
        <stop offset="100%" stopColor="#4A90A4" stopOpacity="0.6" />
      </linearGradient>

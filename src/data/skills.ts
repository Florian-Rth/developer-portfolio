...
export type SkillStats = {
  mastery: number; // Overall mastery (1-10)
  speed: number; // How fast I can ship with it (1-10)
  range: number; // Breadth of use cases (1-10)
...
export const STAT_LABELS: Record<keyof SkillStats, string> = {
  mastery: "Mastery",
  speed: "Speed",
  range: "Range",
  impact: "Impact",
...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    category: "frontend",
    rarity: "epic",
    stats: { mastery: 8, speed: 8, range: 9, impact: 9 },
    flavourText:
      "Writing types is not overhead — it's documentation that bites back when you're wrong.",
    detail: {
  ...
  },
  {
    ...
    category: "frontend",
    rarity: "rare",
    stats: { mastery: 8, speed: 9, range: 9, impact: 8 },
  ...
  },
  {
    ...
    category: "frontend",
    rarity: "rare",
    stats: { mastery: 8, speed: 10, range: 8, impact: 8 },
  ...
  },
  {
    ...
    category: "frontend",
    rarity: "uncommon",
    stats: { mastery: 7, speed: 8, range: 7, impact: 6 },
  ...
  // ── BACKEND ──────────────────────────────────────────────────────────────────
  {
    ...
    category: "backend",
    rarity: "epic",
    stats: { mastery: 8, speed: 7, range: 8, impact: 9 },
    flavourText: "Strongly typed, object-oriented, and responsible for my salary. Respect.",
    detail: {
      learned:
        "Ausbildung bei Schulz Systemtechnik. Tiefer Einstieg durch echte Produktionssoftware.",
  ...
  },
  {
    ...
    stats: { mastery: 8, speed: 7, range: 8, impact: 9 },
    flavourText:
      "Cross-platform. Production-grade. Runs everywhere — even in containers it built itself.",
    detail: {
  ...
  },
  {
    ...
    category: "backend",
    rarity: "rare",
    stats: { mastery: 8, speed: 8, range: 10, impact: 9 },
  ...
  },
  {
    ...
    category: "devops",
    rarity: "rare",
    stats: { mastery: 7, speed: 6, range: 8, impact: 9 },
    flavourText:
      "Complexity that pays off when your service needs to scale to three replicas at 3AM.",
    detail: {
  ...
  },
  {
    ...
    category: "devops",
    rarity: "rare",
    stats: { mastery: 8, speed: 9, range: 8, impact: 9 },
  ...
  },
  {
    ...
    category: "devops",
    rarity: "uncommon",
    stats: { mastery: 7, speed: 8, range: 8, impact: 8 },
  ...
  },
  {
    ...
    category: "devops",
    rarity: "uncommon",
    stats: { mastery: 7, speed: 7, range: 7, impact: 8 },
  ...
  },
  {
    ...
    category: "tools",
    rarity: "uncommon",
    stats: { mastery: 7, speed: 10, range: 7, impact: 7 },

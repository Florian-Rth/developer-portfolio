...
export const HtmlCssArtwork: React.FC = () => {
  return (
    <div className="w-full h-full rounded-lg overflow-hidden flex items-center justify-center bg-card">
      <svg viewBox="0 0 120 80" className="w-[90%] h-[90%]" aria-hidden="true">
        ...
        {/* Labels */}
        <text x="28" y="58" className="font-mono" fontSize="8" fill="#E34F26" textAnchor="middle" opacity="0.7">
          HTML
        </text>
        <text x="88" y="58" className="font-mono" fontSize="8" fill="#264DE4" textAnchor="middle" opacity="0.7">
          CSS
        </text>
      </svg>
    </div>

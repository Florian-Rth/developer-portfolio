...
wave: 3
depends_on: [02-05]
files_modified: [src/components/layout/MobileNav/MobileNav.tsx, src/components/layout/MobileNav/index.ts, src/components/layout/MobileNav/__tests__/MobileNav.test.tsx, src/index.css]
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "src/components/layout/MobileNav/MobileNav.tsx"
      ...
      min_lines: 50
    - path: "src/components/layout/MobileNav/index.ts"
      provides: "MobileNav compound component assembly"
      exports: ["MobileNav", "MobileNavProvider", "useMobileNavContext"]
    - path: "src/components/layout/MobileNav/__tests__/MobileNav.test.tsx"
      provides: "MobileNav component tests"
    - path: "src/index.css"
      provides: "Mobile-specific CSS utility classes"
      contains: "safe-bottom"
  key_links:
    ...
    - from: "src/components/layout/MobileNav/MobileNav.tsx"
      to: "src/components/layout/MobileNav/MobileNavProvider.tsx"
      via: "useMobileNavContext hook"
      pattern: "useMobileNavContext"
---

<objective>
Create mobile bottom navigation with floating glass pill, semantic icons, and glowing progress ring.

Purpose: Provides mobile-optimized navigation that's distinctive (not hamburger menu) with visual feedback showing active section and scroll progress. This plan builds the UI component that consumes the context/provider from plan 02-05.

Output: Working MobileNav compound component with floating bottom navigation, semantic icons, glowing progress ring, and mobile utility CSS.
</objective>
...
@.planning/phases/02-layout-navigation/02-05-SUMMARY.md
</context>
...
<task type="auto">
  ...
  <verify>grep -q 'export { MobileNav }' src/components/layout/MobileNav/index.ts && grep -q 'export.*MobileNavProvider' src/components/layout/MobileNav/index.ts</verify>
...
<task type="auto">
  ...
  <action>
    Add utility class for mobile-specific styling at end of file in @layer components:
  ...
  <verify>grep -A3 '@layer components' src/index.css | grep -q 'safe-area-inset-bottom'</verify>
...
- Mobile safe-area utility class exists
</verification>
...
<output>
After completion, create `.planning/phases/02-layout-navigation/02-06-SUMMARY.md`
</output>
